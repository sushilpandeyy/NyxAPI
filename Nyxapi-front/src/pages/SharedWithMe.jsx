 ...
 return (
   <div className="container mx-auto px-4 py-8">
     <div className="bg-gray-900 rounded-xl shadow-2xl p-8 border border-gray-800">
       <h1 className="text-3xl font-bold text-white mb-8">Shared with me</h1>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         {projects.length ? projects.map(project => (
           <div
             ...
             className="bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-colors border border-gray-700 cursor-pointer"
           >
