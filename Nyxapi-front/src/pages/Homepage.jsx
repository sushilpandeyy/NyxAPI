      ...
      <div className="bg-gray-100 dark:bg-gray-900 sm:py-24 lg:py-1 hh  flex justify-center items-center bb ">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="mt-10 text-center text-white ">
            <h3 className='text-lg text-black'>Introducing</h3>
            <h1 className="text-4xl  font-extrabold text-gray-900  sm:text-5xl lg:text-6xl tt ">
              NyxAPI
            </h1>
            <p className="mt-4 text-1lg text-black ">
    ...
    <div class="max-w-6xl px-6 py-10 mx-auto">
        ...
        <main class="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
            ...
            <div class="w-full p-6 bg-blue-600 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
                <img class="h-24 w-24 md:mx-6 rounded-full object-cover shadow-md md:h-[32rem] md:w-80 lg:h-[36rem] lg:w-[26rem] md:rounded-2xl" src="https://res.cloudinary.com/do5e8qwxk/image/upload/v1730381977/bgg_clfft0.jpg" alt="client photo" />
                
                <div class="mt-2 md:mx-6">
                    

                    <p class=" text-9sm leading-relaxed text-white "> Empowering Developers with Seamless Mock API Generation
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center">Custom Endpoint Creation</h3>
              <p className="mt-4 text-gray-600 dark:text-gray-300 text-center">
              Set up RESTful endpoints with ease to mimic real API calls.
            ...
            <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center">Flexible JSON Data Generation</h3>
              <p className="mt-4 text-gray-600 dark:text-gray-300 text-center">
              Choose from various data types and structures to generate randomized responses that simulate production data.
            ...
            <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center">Independent Frontend Development</h3>
              <p className="mt-4 text-gray-600 dark:text-gray-300 text-center">
              Empower your frontend team to progress independently, eliminating the need to wait for backend availability.
              </p>
            </div>
          </div>
        </div>
      </div>
      <footer class="bg-white dark:bg-gray-900 mx-auto">
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            <a href="#">
            <h1 className={`text-3xl font-bold roboto-flex-bold text-blue-500`}>
              NyxAPI
            </h1>
            </a>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            <p class="text-sm text-gray-500 dark:text-gray-300">©️ Copyright 2021. All Rights Reserved.</p>
